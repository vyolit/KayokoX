...
- (void)loadView {
    ...
    [[self iconImageView] setImage:[CommonUtil appIcon]];
    ...
    [[self titleLabel] setStringValue:[CommonUtil appName]];
    ...
    [[self versionLabel] setStringValue:[NSString stringWithFormat:@"%@: %@", NSLocalizedString(@"AboutPreferencesVersion", nil), [CommonUtil appVersion]]];
