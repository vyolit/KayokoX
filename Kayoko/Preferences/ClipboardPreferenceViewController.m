...
- (void)setHistorySize {
    ...
    [[[Environment sharedInstance] preferenceLoader] setPreference:@(historySize) forKey:kPreferenceKeyMaximumHistoryAmount];
...
- (void)setSaveText {
    ...
    [[[Environment sharedInstance] preferenceLoader] setPreference:@(saveText) forKey:kPreferenceKeySaveText];
}

- (void)setSaveFiles {
    BOOL saveFiles = [[self saveFilesCell] isOn];
    [[[Environment sharedInstance] preferenceLoader] setPreference:@(saveFiles) forKey:kPreferenceKeySaveFiles];
}

- (void)setAutomaticallyPaste {
    BOOL automaticallyPaste = [[self automaticallyPasteCell] isOn];
    [[[Environment sharedInstance] preferenceLoader] setPreference:@(automaticallyPaste) forKey:kPreferenceKeyAutomaticallyPaste];
}

- (void)loadPreferences {
    NSUInteger historySize = [[[Environment sharedInstance] preferenceLoader] maximumHistoryAmount];
    BOOL saveText = [[[Environment sharedInstance] preferenceLoader] saveText];
    BOOL saveFiles = [[[Environment sharedInstance] preferenceLoader] saveFiles];
    BOOL automaticallyPaste = [[[Environment sharedInstance] preferenceLoader] automaticallyPaste];
